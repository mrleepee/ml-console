...
optionDecl: KW_DECLARE KW_OPTION (name=qName value=stringLiteral | mappingDecl) ;

mappingDecl: XDMP_MAPPING_FALSE;
// EXPRESSIONS /////////////////////////////////////////////////////////////////
...
pathExpr: (SLASH relativePathExpr?) | (descendantPath relativePathExpr) | relativePathExpr ;

relativePathExpr: stepExpr((SLASH | descendantPath) stepExpr)* ;

descendantPath: DSLASH ;
